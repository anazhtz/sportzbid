...
class AppColors {
  static final Color primaryColor = HexColor('#2B2738');
  static final Color secondaryColor = HexColor('#3B364C');
  static final Color textFeildColor = HexColor('#2B2738');
  ...
  static final Color buttonColor = HexColor('#5D44B0');
